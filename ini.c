...
//return 0;
    ...
    IniSetLongBin("desktops.ini", "global1.definitions.fixedareas.1.top.AsLongBIN", 198198198198198198);
    IniSetIntBin("desktops.ini", "global1.definitions.fixedareas.1.top.AsIntBIN", 1981981981);
